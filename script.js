...
const resetKey = document.querySelector(".reset-button");
const answerKey = document.querySelector(".answer-button");
const deleteKey = document.querySelector(".delete-button");
